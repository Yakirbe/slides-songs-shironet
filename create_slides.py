"""
Create PowerPoint slides from Shironet URLs
Extracts lyrics from HTML fetched via browser tools and creates presentation
"""
import re
import os
...
def process_html_content(html_content: str, song_info: dict) -> dict:
    """Process HTML content and return song data for presentation."""
...
# Example: Process the first song's HTML that we just fetched
if __name__ == "__main__":
    ...
    print("For each URL:")
    print("1. Use browser_navigate to visit the URL")
    print("2. Use mcp_fetch_fetch to get the HTML")
    print("3. Pass the HTML to process_html_content()")
    print("4. Create presentation with all songs")
    print("\nOr run main.py which will attempt automated fetching.")
